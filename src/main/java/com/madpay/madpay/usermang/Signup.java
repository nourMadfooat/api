...
public class Signup extends AbstractVerticle {
  ...
  private void applySignup(Message<Object> handler, Promise<Object> promise) {
  ...
  private void successDb(Promise<Object> promise,JsonObject response,JsonObject body,RowSet<Row> res) {
    if(res.rowCount() > 1){
